...
There are currently 32 different models available in in the rhinno package that have been trained on TCR or BCR data. These models vary by **encoder.model**, **encoder.input**, and **chain** but follow the above architectures. Loading of the neural-network models uses the ```loadRhino()``` function. 
